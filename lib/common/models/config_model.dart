class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    appMinimumVersionAndroid =
        json['app_minimum_version_android_restaurant'] != null
            ? json['app_minimum_version_android_restaurant']?.toDouble()
            : 0.0;
    appMinimumVersionIos = json['app_minimum_version_ios_restaurant'] != null
        ? json['app_minimum_version_ios_restaurant']?.toDouble()
        : 0.0;
    takeAway = json['take_away'];
    additionalChargeName = json['additional_charge_name'];
    dmPictureUploadStatus =
        json['dm_picture_upload_status'] == 1 ? true : false;
