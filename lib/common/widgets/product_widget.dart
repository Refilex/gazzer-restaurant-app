...
import 'package:gazzer_vendorapp/common/widgets/discount_tag_widget.dart';
import 'package:gazzer_vendorapp/common/widgets/not_available_widget.dart';
...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => Get.toNamed(RouteHelper.getProductDetailsRoute(product),
                  ...
                  ? Stack(children: [
                      ClipRRect(
                        ...
                        child: CustomImageWidget(
                          image:
                              '${isCampaign ? baseUrls!.campaignImageUrl : baseUrls!.productImageUrl}/${product.image}',
                ...
                onPressed: () {
                  if (Get.find<ProfileController>()
                    ...
                    Get.find<RestaurantController>()
                      ...
                      if (itemDetails != null) {
                        Get.toNamed(
                            RouteHelper.getAddProductRoute(itemDetails));
                      }
                    });
                  } else {
                ...
                onPressed: () {
                  if (Get.find<ProfileController>()
                    ...
                    Get.dialog(ConfirmationDialogWidget(
                      ...
                      onYesPressed: () => Get.find<RestaurantController>()
