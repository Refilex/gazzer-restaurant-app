...
class AddAddonBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<AddAddonBottomSheetWidget> createState() =>
      _AddAddonBottomSheetWidgetState();
}
...
class _AddAddonBottomSheetWidgetState extends State<AddAddonBottomSheetWidget>
  ...
  void initState() {
    ...
    _stockTextController.text = widget.addon?.addonStock == 0
        ? ''
        : widget.addon?.addonStock!.toString() ?? '';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restaurantController) {
      List<DropdownItem<int>> stockTypeList =
          _generateStockTypeList(restaurantController.stockTypeList, context);
        ...
        child: SingleChildScrollView(
          ...
          SizedBox(
            ...
            child: TabBar(
              ...
              labelPadding:
                  const EdgeInsets.only(right: Dimensions.radiusDefault),
              isScrollable: true,
          ...
          Row(children: [
                    ...
                    child: CustomDropdownWidget<int>(
                      ...
                      child: Text(
                        restaurantController
                            .stockTypeList[
                                restaurantController.stockTypeIndex!]!
                            .tr,
            ...
            Expanded(
                child: Column(
                    ...
                    children: [
                  CustomTextFormFieldWidget(
                    hintText: restaurantController.stockTypeIndex == 0
                        ? 'unlimited'.tr
                        : 'addon_stock'.tr,
                    ...
                    showTitle: false,
                    readOnly: restaurantController.stockTypeIndex == 0 ||
                            (restaurantController.stockTextFieldDisable)
                        ? true
                        : false,
                  ),
                ])),
          ...
          GetBuilder<AddonController>(builder: (addonController) {
            return !addonController.isLoading
                ? CustomButtonWidget(
                    onPressed: () {
                      ...
                      if (name.isEmpty) {
                        ...
                        showCustomSnackBar('enter_addon_price'.tr);
                          ...
                          restaurantController.stockTypeIndex != 0) {
                        ...
                        for (int index = 0;
                          ...
                          nameList.add(Translation(
                            ...
                            key: 'name',
                            value:
                                _nameControllers[index].text.trim().isNotEmpty
                        ...
                        AddOns addon = AddOns(
                          ...
                          stockType: restaurantController.stockTypeIndex == 0
                              ? 'unlimited'
                              : restaurantController.stockTypeIndex == 1
                                  ? 'limited'
                                  : 'daily',
                        );
                    ...
                    buttonText:
                        widget.addon != null ? 'update'.tr : 'submit'.tr,
                  )
  ...
  List<DropdownItem<int>> _generateStockTypeList(
      List<String?> typeList, BuildContext context) {
