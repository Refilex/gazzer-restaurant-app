...
import 'package:gazzer_vendorapp/features/auth/domain/models/restaurant_body_model.dart';
import 'package:gazzer_vendorapp/features/auth/widgets/additional_data_section_widget.dart';
import 'package:gazzer_vendorapp/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:gazzer_vendorapp/features/auth/widgets/pass_view_widget.dart';
import 'package:gazzer_vendorapp/features/auth/widgets/select_location_view_widget.dart';
    ...
    return GetBuilder<AuthController>(builder: (authController) {
      return GetBuilder<LocationController>(builder: (locationController) {
        return GetBuilder<RestaurantController>(
          ...
          if (locationController.storeAddress != null &&
              _languageList!.isNotEmpty) {
            _addressController[0].text =
                locationController.storeAddress.toString();
          }
          List<int> cuisines = [];
          if (restaurantController.cuisineModel != null) {
            for (int index = 0;
                index < restaurantController.cuisineModel!.cuisines!.length;
                index++) {
              if (restaurantController.cuisineModel!.cuisines![index].status ==
                      1 &&
                  !restaurantController.selectedCuisines!.contains(index)) {
                cuisines.add(index);
              }
            }
          }
          ...
          return PopScope(
            ...
            child: Scaffold(
              appBar: CustomAppBarWidget(
                  title: 'restaurant_application'.tr,
                  onBackPressed: () => _showBackPressedDialogue(
                              ...
                              child: Column(children: [
                                Visibility(
                                  ...
                                  child: Column(children: [
                                    ...
                                    locationController.zoneList != null
                                    ...
                                    Column(children: [
                                      Autocomplete<int>(
                                        ...
                                        displayStringForOption: (value) =>
                                            restaurantController.cuisineModel!
                                                .cuisines![value].name!,
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(
                                            height: Dimensions
                                                .paddingSizeExtraLarge),
                                        CustomTextFieldWidget(
                                          hintText: ResponsiveHelper.isDesktop(
                                                  context)
                                              ? 'phone'.tr
                                ...
                                onPressed: () {
                                  ...
                                  if (authController.storeStatus != 0.4) {
                                    for (Data data
                                      ...
                                      int index = authController.dataList!
                                          .indexOf(data);
                                  ...
                                  if (authController.storeStatus == 0.4) {
                                    ...
                                    if (fName.isEmpty) {
                                      ...
                                      for (var index in restaurantController
                                          .selectedCuisines!) {
                                        cuisines.add(restaurantController
