...
import 'package:gazzer_vendorapp/features/auth/widgets/location_search_dialog_widget.dart';
import 'package:gazzer_vendorapp/features/auth/widgets/zone_selection_view_widget.dart';
...
class SelectLocationViewWidget extends StatefulWidget {
  ...
  const SelectLocationViewWidget(
      {super.key, required this.fromView, this.mapController});
...
class _SelectLocationViewWidgetState extends State<SelectLocationViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LocationController>(builder: (locationController) {
      ...
      if (locationController.zoneList != null &&
          locationController.zoneIds != null) {
        for (int index = 0;
            index < locationController.zoneList!.length;
            index++) {
          if (locationController.zoneIds!
              .contains(locationController.zoneList![index].id)) {
  ...
  Widget mapView(LocationController locationController) {
    return locationController.zoneList!.isNotEmpty
        ? Container(
