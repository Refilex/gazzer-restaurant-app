...
class BusinessController extends GetxController implements GetxService {
  ...
  int _businessIndex = Get.find<SplashController>().configModel!.businessPlan !=
              null &&
          Get.find<SplashController>().configModel!.businessPlan!.commission ==
              0
      ? 1
      : 0;
  ...
  void resetBusiness() {
    _businessIndex =
        (Get.find<SplashController>().configModel!.businessPlan != null &&
  ...
  Future<ResponseModel> setUpBusinessPlan(
      BusinessPlanModel businessPlanBody) async {
    _isLoading = true;
    update();
    Response response =
