        ...
        child: Row(children: [
          ClipRRect(
            ...
            child: CustomImageWidget(
              image:
                  '${Get.find<SplashController>().configModel!.baseUrls!.campaignImageUrl}/${campaignModel.image}',
              height: 85,
              width: 100,
              fit: BoxFit.cover,
            ),
                ...
                Row(children: [
                  InkWell(
                    onTap: () {
                      if (campaignModel.vendorStatus == null) {
                        Get.dialog(ConfirmationDialogWidget(
                          ...
                          onYesPressed: () {
                            Get.find<CampaignController>()
                                .joinCampaign(campaignModel.id, false);
                          },
                        ));
                        ...
                        Get.dialog(ConfirmationDialogWidget(
                          ...
                          onYesPressed: () {
                            Get.find<CampaignController>()
                                .leaveCampaign(campaignModel.id, false);
                          },
                        ));
                      }
                    },
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: campaignModel.vendorStatus == null
                            ? Theme.of(context).primaryColor
                            : campaignModel.vendorStatus == 'rejected'
                      ...
                      child: Text(
                          campaignModel.vendorStatus == null
                              ? 'join_now'.tr
                              : campaignModel.vendorStatus != 'confirmed'
                                  ? campaignModel.vendorStatus!.tr
                                  : 'leave_now'.tr,
                  ...
                  Text(
                    DateConverter.convertDateToDate(
                        campaignModel.availableDateStarts!),
                    style: robotoRegular.copyWith(
                        fontSize: Dimensions.fontSizeExtraSmall,
                        color: Theme.of(context).disabledColor),
                  ),
