...
import 'package:gazzer_vendorapp/common/widgets/custom_loader_widget.dart';
...
import 'package:gazzer_vendorapp/features/coupon/widgets/coupon_card_dialogue_widget.dart';
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          Row(
                                              ...
                                              children: [
                                                Text(
                                                  '${'${couponController.couponList![index].couponType == 'free_delivery' ? 'free_delivery'.tr : couponController.couponList![index].discountType != 'percent' ? PriceConverter.convertPrice(double.parse(couponController.couponList![index].discount.toString())) : couponController.couponList![index].discount}'} ${couponController.couponList![index].couponType == 'free_delivery' ? '' : couponController.couponList![index].discountType == 'percent' ? ' %' : ''}'
                                          ...
                                          Text(
                                              '${'code'.tr}: ${couponController.couponList![index].code!}',
                                              style: robotoMedium),
                                          const SizedBox(height: 5),
                                          Text(
                                              '${'total_users'.tr}: ${couponController.couponList![index].totalUses}',
                                              style: robotoRegular.copyWith(
                                                  fontSize: Dimensions
                                                      .fontSizeExtraSmall)),
                                          const SizedBox(height: 5),
                                          Text(
                                            '${'valid_until'.tr} ${couponController.couponList![index].startDate!}  ${'to'.tr} ${couponController.couponList![index].expireDate!}',
                                            style: robotoRegular.copyWith(
                                                fontSize: Dimensions
                                                    .fontSizeExtraSmall),
                                          ),
