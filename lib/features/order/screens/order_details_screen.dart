...
import 'package:gazzer_vendorapp/common/widgets/input_dialog_widget.dart';
...
import 'package:gazzer_vendorapp/features/order/screens/invoice_print_screen.dart';
import 'package:gazzer_vendorapp/features/order/widgets/available_deliveryman_bottom_sheet_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/dialogue_image_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/order_product_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/slider_button_widget.dart';
import 'package:gazzer_vendorapp/features/order/widgets/verify_delivery_sheet_widget.dart';
...
class OrderDetailsScreen extends StatefulWidget {
  ...
  const OrderDetailsScreen(
      {super.key, required this.orderModel, required this.isRunningOrder});
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<ProfileController>().profileModel != null &&
        Get.find<ProfileController>().profileModel!.restaurants != null) {
    ...
    return GetBuilder<OrderController>(builder: (orderController) {
      ...
      bool showDeliveryConfirmImage = orderController.showDeliveryImageField &&
          Get.find<SplashController>().configModel!.dmPictureUploadStatus!;

      bool canShowDeliveryMan = controllerOrderModel != null
          ? controllerOrderModel.orderType != 'take_away' &&
              (controllerOrderModel.orderStatus == 'pending' ||
                  controllerOrderModel.orderStatus == 'confirmed' ||
                  controllerOrderModel.orderStatus == 'processing' ||
        ...
        body: (orderController.orderDetailsModel != null &&
            ...
            ? Column(children: [
                      ...
                      child: SizedBox(
                          ...
                          child: Column(
                              ...
                              children: [
                                                              ...
                                                              builder:
                                                                ...
                                                                return ConstrainedBox(
                                                                  constraints: BoxConstraints(
                                                                      ...
                                                                      minHeight:
                                                                          200),
                                                                  child: AvailableDeliveryManBottomSheetWidget(
                                                                      orderId:
                                                                          order
                                                                              .id!,
                                                                      assignedDeliveryManId: order
                                                                          .deliveryMan
                                                                          ?.id),
                                                                );
                                                              },
                                ...
                                (controllerOrderModel.orderStatus ==
                                            'delivered' &&
                                        controllerOrderModel.orderProof !=
                                            null &&
                                        controllerOrderModel
                                            .orderProof!.isNotEmpty)
                                    ? Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                              ...
                                              itemBuilder:
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () => openDialog(
                                                        context,
                                                        '${Get.find<SplashController>().configModel!.baseUrls!.orderAttachmentUrl}/${controllerOrderModel.orderProof![index]}'),
                                                    child: Center(
                                                        child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                ...
                showDeliveryConfirmImage &&
                    ...
                    : const SizedBox(),
                SafeArea(
                  child: showDeliveryConfirmImage &&
                          controllerOrderModel.orderStatus != 'delivered'
                      ? Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: Dimensions.paddingSizeSmall),
                ...
                (!GetPlatform.isIOS && !GetPlatform.isWeb)
                    ? Padding(
                        padding:
