...
import 'package:gazzer_vendorapp/features/order/widgets/price_widget.dart';
          ...
          child: Screenshot(
            ...
            child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      height:
                          addOns > 0 ? Dimensions.paddingSizeExtraSmall : 0),
                  PriceWidget(
                      title: 'subtotal'.tr,
                  ...
                  (order!.referrerBonusAmount! > 0)
                      ? PriceWidget(
                          ...
                          value: _priceDecimal(order!.referrerBonusAmount!),
                          fontSize: fontSize)
                      : const SizedBox(),
                  SizedBox(height: order!.referrerBonusAmount! > 0 ? 5 : 0),
                  PriceWidget(
                    title:
                        '${'vat_tax'.tr}${order!.taxStatus! ? '(${'tax_included'.tr})' : ''}',
                  ...
                  (order!.extraPackagingAmount! > 0)
                      ? PriceWidget(
                          ...
                          value: _priceDecimal(order!.extraPackagingAmount!),
                          fontSize: fontSize)
                      : const SizedBox(),
                  ...
                  order!.paymentMethod == 'partial_payment'
                      ? Column(children: [
                          ...
                          PriceWidget(
                              ...
                              value: _priceDecimal(order!.payments![0].amount!),
                              fontSize: fontSize),
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                          PriceWidget(
                              ...
                              value: _priceDecimal(order!.payments![1].amount!),
                              fontSize: fontSize),
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                        ])
