...
import 'package:gazzer_vendorapp/features/payment/widgets/wallet_attention_alert_widget.dart';
import 'package:gazzer_vendorapp/features/payment/widgets/wallet_widget.dart';
import 'package:gazzer_vendorapp/features/payment/widgets/withdraw_request_bottom_sheet_widget.dart';
import 'package:gazzer_vendorapp/features/payment/widgets/withdraw_widget.dart';
      ...
      body: GetBuilder<ProfileController>(builder: (profileController) {
        return GetBuilder<PaymentController>(builder: (paymentController) {
          return (profileController.profileModel != null &&
                  paymentController.withdrawList != null)
              ? RefreshIndicator(
                  onRefresh: () async {
                        ...
                        child: Column(
                            ...
                            children: [
                                            ...
                                            ? InkWell(
                                                onTap: () {
                                                  if (paymentController
                                                    ...
                                                    showCustomSnackBar(
                                                        'currently_no_bank_account_added'
                                                            .tr);
                                                  }
                                                },
                                                child: Container(
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                    child: WalletWidget(
                                        title: 'withdraw_able_balance'.tr,
                                        value: profileController
                              ...
                              Padding(
                                ...
                                child: Row(children: [
                                  InkWell(
                                    onTap: () {
                                      if (paymentController.selectedIndex !=
                                          0) {
                              ...
                              if (paymentController.selectedIndex == 0)
                                paymentController.withdrawList != null
                                    ? paymentController.withdrawList!.isNotEmpty
                                        ? ListView.builder(
                                            physics:
                                            ...
                                            itemBuilder: (context, index) {
                                              return WithdrawWidget(
                                                withdrawModel: paymentController
                                                    .withdrawList![index],
                                                showDivider: index !=
                                                    (paymentController
                                                                .withdrawList!
                              ...
                              if (paymentController.selectedIndex == 1)
                                paymentController.transactions != null
