...
class AddBankBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<AddBankBottomSheetWidget> createState() =>
      _AddBankBottomSheetWidgetState();
}
      ...
      child: SingleChildScrollView(
        ...
        GetBuilder<PaymentController>(builder: (paymentController) {
          return !paymentController.isLoading
              ? CustomButtonWidget(
                  buttonText:
                      widget.bankName != null ? 'update'.tr : 'add_bank'.tr,
                  onPressed: () {
                    ...
                    if (widget.bankName == bankName &&
                        widget.branchName == branchName &&
                        widget.holderName == holderName &&
                      ...
                      Get.find<PaymentController>()
                          .updateBankInfo(BankInfoBodyModel(
                        bankName: bankName,
                        branch: branchName,
