                    ...
                    Row(children: [
                      Expanded(
                        child: CustomTextFormFieldWidget(
                          titleName: paymentController
                              .methodFields[index].inputName
                              .toString()
                              .replaceAll('_', ' '),
                          hintText:
                              paymentController.methodFields[index].placeholder,
                          controller:
                              paymentController.textControllerList[index],
                          capitalization: TextCapitalization.words,
                          inputType:
                              paymentController.methodFields[index].inputType ==
                                      'phone'
                                  ? TextInputType.phone
                                  : paymentController
                                      ...
                                      : paymentController.methodFields[index]
                                                  .inputType ==
                                              'email'
                          ...
                          nextFocus:
                              index != paymentController.methodFields.length - 1
                                  ? paymentController.focusList[index + 1]
                                  : _amountFocus,
                          isRequired: paymentController
                ...
                ? CustomButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      for (var element in paymentController.methodFields) {
                        if (element.isRequired == 1) {
                          if (paymentController
                              .textControllerList[paymentController.methodFields
                                  .indexOf(element)]
                              .text
                              .isEmpty) {
                            fieldEmpty = true;
                      ...
                      if (fieldEmpty) {
                        ...
                        data['id'] = paymentController
                            .widthDrawMethods![paymentController.methodIndex!]
                            .id
                            .toString();
                        data['amount'] = _amountController.text.trim();
                        for (var result in paymentController.methodFields) {
                          data[result.inputName] = paymentController
                              .textControllerList[paymentController.methodFields
                                  .indexOf(result)]
                              .text
                              .trim();
