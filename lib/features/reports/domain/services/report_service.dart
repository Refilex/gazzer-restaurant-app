...
class ReportService implements ReportServiceInterface {
  ...
  Future<TransactionReportModel?> getTransactionReportList(
    ...
    return await reportRepositoryInterface.getTransactionReportList(
        offset: offset, from: from, to: to);
  }

  @override
  Future<OrderReportModel?> getOrderReportList(
      {required int offset, required String? from, required String? to}) async {
    return await reportRepositoryInterface.getOrderReportList(
        offset: offset, from: from, to: to);
  }
  ...
  Future<OrderReportModel?> getCampaignReportList(
      {required int offset, required String? from, required String? to}) async {
    return await reportRepositoryInterface.getCampaignReportList(
        offset: offset, from: from, to: to);
  }
  ...
  Future<FoodReportModel?> getFoodReportList(
      {required int offset, required String? from, required String? to}) async {
    return await reportRepositoryInterface.getFoodReportList(
        offset: offset, from: from, to: to);
  }
}
