...
import 'package:gazzer_vendorapp/features/reports/screens/food/widget/food_report_details_card_widget.dart';
import 'package:gazzer_vendorapp/features/reports/screens/food/widget/line_chart_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ReportController>(builder: (reportController) {
        return reportController.foods != null
            ? SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      reportController.foods != null
                          ? reportController.foods!.isNotEmpty
                              ? ListView.builder(
                                  padding: const EdgeInsets.all(
                                  ...
                                  itemBuilder: (context, index) {
                                    return FoodReportDetailsCardWidget(
                                        foods: reportController.foods![index]);
                                  },
                                )
                              : Center(
                                  child: Padding(
