          ...
          child: Column(children: [
            ...
            Column(children: [
              ...
              SizedBox(
                  ...
                  child: Text(foods.name.toString(),
                      maxLines: 1,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text('${'average_ratings'.tr} - ',
                    style: robotoMedium.copyWith(
                        fontSize: Dimensions.fontSizeLarge)),
                const Icon(Icons.star, color: Colors.blue, size: 15),
                Text('${foods.averageRatings!.toStringAsFixed(1)}' ' ',
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Row(
                    ...
                    children: [
                      ...
                      Text(foods.totalOrderCount.toString(),
                          style: robotoRegular),
                    ]),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'order_amount'.tr, amount: foods.unitPrice ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'total_discount'.tr,
                    amount: foods.totalDiscountGiven ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'average_sales_value'.tr,
                    amount: foods.averageSaleValue ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'total_amount'.tr,
                    amount: foods.totalAmountSold ?? 0),
              ]),
            ),
          ),
        ),
