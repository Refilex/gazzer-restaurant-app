...
import 'package:gazzer_vendorapp/features/reports/screens/order/widget/order_status_card_widget.dart';
import 'package:gazzer_vendorapp/features/reports/widgets/report_details_card_widget.dart';
    ...
    return Scaffold(
      appBar: CustomAppBarWidget(
        ...
        menuWidget: IconButton(
          ...
          onPressed: () =>
              Get.find<ReportController>().showDatePicker(context, order: true),
        ),
      ),
      body: GetBuilder<ReportController>(builder: (reportController) {
        return reportController.orders != null
            ? SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                            ...
                            child: Row(children: [
                              Column(children: [
                                OrderStatusCardWidget(
                                  ...
                                  totalCount: reportController
                                          .otherData!.totalScheduledCount ??
                                      0,
                                ),
                                const SizedBox(
                      ...
                      reportController.orders != null
                          ? reportController.orders!.isNotEmpty
                              ? ListView.builder(
                                  padding: const EdgeInsets.all(
                                      Dimensions.paddingSizeDefault),
                                  shrinkWrap: true,
                                  ...
                                  itemBuilder: (context, index) {
                                    return ReportDetailsCardWidget(
                                        orders:
                                            reportController.orders![index]);
                                  },
                                )
                              : Center(
                                  child: Padding(
