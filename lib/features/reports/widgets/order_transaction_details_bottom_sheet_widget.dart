...
class OrderTransactionDetailsBottomSheetWidget extends StatelessWidget {
  ...
  const OrderTransactionDetailsBottomSheetWidget(
          ...
          child: Column(children: [
            ...
            Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text(orders.amountReceivedBy.toString(),
                    style: robotoBold.copyWith(
                        fontSize: Dimensions.fontSizeDefault)),
              ]),
            ]),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                TitleWithAmountWidget(
                    title: 'order_amount'.tr, amount: orders.orderAmount ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'food_discount'.tr,
                    amount: orders.itemDiscount ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'coupon_discount'.tr,
                    amount: orders.couponDiscount ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'total_discount'.tr,
                    amount: orders.discountedAmount ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'vat_tax'.tr, amount: orders.tax ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'delivery_charge'.tr,
                    amount: orders.deliveryCharge ?? 0),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                TitleWithAmountWidget(
                    title: 'total_order_amount'.tr,
                    amount: orders.totalItemAmount ?? 0),
              ]),
            ),
          ),
        ),
