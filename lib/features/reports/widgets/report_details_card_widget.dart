...
class ReportDetailsCardWidget extends StatelessWidget {
  ...
  const ReportDetailsCardWidget(
      {super.key, required this.orders, this.isCampaign = false});
                ...
                showModalBottomSheet(
                  ...
                  builder: (context) {
                    return ConstrainedBox(
                      ...
                      child: OrderTransactionDetailsBottomSheetWidget(
                          orders: orders),
                    );
                  },
                );
            ...
            child: Row(children: [
              ...
              Column(
                  ...
                  children: [
                    ...
                    Text(PriceConverter.convertPrice(orders.orderAmount),
