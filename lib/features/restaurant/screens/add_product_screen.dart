...
import 'package:gazzer_vendorapp/common/widgets/custom_time_picker_widget.dart';
...
import 'package:gazzer_vendorapp/features/restaurant/widgets/stock_section_widget.dart';
import 'package:gazzer_vendorapp/features/splash/controllers/splash_controller.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/models/variation_model.dart';
...
import 'package:gazzer_vendorapp/features/restaurant/widgets/variation_view_widget.dart';
...
class _AddProductScreenState extends State<AddProductScreen>
  ...
  final bool restaurantHalalActive = Get.find<ProfileController>()
      .profileModel!
      .restaurants![0]
      .isHalalActive!;
  ...
  void initState() {
    ...
    if (_update) {
      ...
      _stockTextController.text =
          _product!.itemStock == 0 ? '' : _product!.itemStock!.toString();
                    ...
                    Expanded(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'insert_language_wise_product_name_and_description'
                                            .tr,
                            ...
                            const SizedBox(
                                height: Dimensions.paddingSizeDefault),
                            Text('restaurants_and_category_info'.tr,
                                style: robotoMedium),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            Container(
                              padding: const EdgeInsets.symmetric(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton<int>(
                                        ...
                                        onChanged: (int? value) {
                                          categoryController
                                              .setSubCategoryIndex(value, true);
                                        },
                                        isExpanded: true,
                                        underline: const SizedBox(),
                                      ),
                                            ...
                                            style: robotoMedium.copyWith(
                                                color: restController.isVeg
                                                    ...
                                                    : Theme.of(context)
                                                        .disabledColor,
                                                fontSize: 13)),
                                        groupValue: restController.isVeg
                                            ? 'veg'
                                            : 'non_veg',
                                        value: 'veg',
                                        contentPadding: EdgeInsets.zero,
                            ...
                            Container(
                              ...
                              child: Column(children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    itemCount:
                                        restController.selectedAddons!.length,
                            ...
                            Container(
                              ...
                              child: Column(children: [
                                ...
                                StackSectionWidget(
                                    ...
                                    stockTextController: _stockTextController),
                                const SizedBox(
                                    height: Dimensions.paddingSizeOverLarge),
                                Row(children: [
                                  Expanded(
                                ...
                                Align(
                                    ...
                                    child: Stack(children: [
                                      ...
                                      Positioned(
                                        ...
                                        left: 0,
                                        child: InkWell(
                                          onTap: () => restController.pickImage(
                                              true, false),
                                          child: DottedBorder(
                                            color:
                                                Theme.of(context).primaryColor,
                    ...
                    !restController.isLoading
                        ? CustomButtonWidget(
                            ...
                            onPressed: () {
                              ...
                              try {
                                itemStock =
                                    int.parse(_stockTextController.text.trim());
                              } catch (e) {
                                itemStock = 0;
                              }
                              ...
                              for (VariationModel variationModel
                                ...
                                if (variationModel
                                  ...
                                  for (Option option
                                    ...
                                    } else if (option.optionStockController!
                                            .text.isEmpty &&
                                        restController.stockTypeIndex != 0) {
                              ...
                              if (defaultDataNull) {
                              ...
                              } else if (_stockTextController.text.isEmpty &&
                                  restController.stockTypeIndex != 0) {
                                ...
                                showCustomSnackBar(
                                    'enter_option_stock_for_every_variation'
                                        .tr);
                                ...
                                showCustomSnackBar(
                                    'maximum_item_order_quantity_can_not_be_negative'
                                        .tr);
                              } else if (_product!.availableTimeStarts ==
                                  null) {
                                ...
                                _product!.itemStock =
                                    itemStock == 0 ? null : itemStock;
                                _product!.stockType =
                                    restController.stockTypeIndex == 0
                                        ? 'unlimited'
                                        : restController.stockTypeIndex == 1
                                            ? 'limited'
                                            : 'daily';
                                _product!.variations = [];
                                    ...
                                    for (var option in variation.options!) {
                                      values.add(VariationOption(
                                        ...
                                        optionPrice: option
                                            ...
                                            .trim(),
                                        totalStock: option
                                                    .optionStockController!.text
                                                    .trim() ==
                                                ''
                                            ? '0'
                                            : option.optionStockController!.text
                                                .trim(),
                                ...
                                restController.addProduct(
                                    _product!,
                                    widget.product == null,
                                    _deletedVariationIds,
                                    _deletedVariationOptionIds);
                              }
                            },
                          )
