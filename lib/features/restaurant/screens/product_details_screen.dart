...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.find<RestaurantController>()
        .setRecommended(product.recommendedStatus == 1);
              ...
              child: Column(
                  ...
                  children: [
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(
                                          height:
                                              Dimensions.paddingSizeExtraSmall),
                                      ListView.builder(
                                        itemCount: product.variations![index]
                    ...
                    product.addOns!.isNotEmpty
                        ...
                        : const SizedBox(),
                    SizedBox(
                        height: product.addOns!.isNotEmpty
                            ? Dimensions.paddingSizeExtraSmall
                            : 0),
                    product.addOns!.isNotEmpty
                        ? ListView.builder(
                    ...
                    product.tags != null && product.tags!.isNotEmpty
                        ? Text('tags'.tr, style: robotoMedium)
                        : const SizedBox(),
                    SizedBox(
                        height: product.tags != null && product.tags!.isNotEmpty
                            ? Dimensions.paddingSizeExtraSmall
                            : 0),
                    product.tags != null && product.tags!.isNotEmpty
                        ? ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              return Text(product.tags![index].tag!,
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall));
                            },
                          )
                            ...
                            children: [
                                ...
                                haveSubscription
                                    ...
                                    : Padding(
                                        ...
                                        child: Center(
                                            child: Text(
                                                'not_available_subscription_for_reviews'
                                                    .tr,
                                                style: robotoRegular.copyWith(
                                                    color: Theme.of(context)
                                                        .disabledColor))),
