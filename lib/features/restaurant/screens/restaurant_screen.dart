...
class _RestaurantScreenState extends State<RestaurantScreen>
  ...
  final bool? _review = Get.find<ProfileController>()
      .profileModel!
      .restaurants![0]
      .reviewsSection;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      return GetBuilder<ProfileController>(builder: (profileController) {
        ...
        if (profileController.profileModel!.restaurants![0].restaurantModel ==
            'subscription') {
          haveSubscription =
        ...
        Restaurant? restaurant = profileController.profileModel != null
            ? profileController.profileModel!.restaurants![0]
            : null;
                        ...
                        if (_tabController!.index == 0) {
                          ...
                          return haveSubscription
                              ? restController.restaurantReviewList != null
                                  ? restController
                                          .restaurantReviewList!.isNotEmpty
                                      ? ListView.builder(
