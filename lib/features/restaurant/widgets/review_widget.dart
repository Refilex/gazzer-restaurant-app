      ...
      Row(children: [
        ClipOval(
          child: CustomImageWidget(
            image:
                '${fromRestaurant ? Get.find<SplashController>().configModel!.baseUrls!.productImageUrl : Get.find<SplashController>().configModel!.baseUrls!.customerImageUrl}/${fromRestaurant ? review.foodImage : review.customer != null ? review.customer!.image : ''}',
            height: 60,
            width: 60,
            fit: BoxFit.cover,
          ),
              ...
              Text(
                fromRestaurant
                    ...
                    : review.customer != null
                        ? '${review.customer != null ? review.customer!.fName : ''} ${review.customer != null ? review.customer!.lName : ''}'
                        : 'customer_not_found'.tr,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: robotoMedium.copyWith(
                    fontSize: Dimensions.fontSizeSmall,
                    color: review.customer != null
                        ? Theme.of(context)
                            .textTheme
                            .displayLarge!
                            .backgroundColor
