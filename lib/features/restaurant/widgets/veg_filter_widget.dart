        ...
        ? Align(
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemCount:
                    Get.find<RestaurantController>().productTypeList.length,
                physics: const NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () => onSelected!(Get.find<RestaurantController>()
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Get.find<RestaurantController>()
                                    .productTypeList[index] ==
                                type
                      ...
                      child: Text(
                        Get.find<RestaurantController>()
                            .productTypeList[index]
                            .tr,
                        style: Get.find<RestaurantController>()
                                    .productTypeList[index] ==
                                type
