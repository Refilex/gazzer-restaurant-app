...
class ReviewReplyScreen extends StatefulWidget {
  ...
  const ReviewReplyScreen(
      ...
      this.restaurantReviewReplyStatus = false});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
          title: !widget.restaurantReviewReplyStatus!
              ? 'review'.tr
              : widget.restaurantReviewReplyStatus! && widget.isGiveReply
                  ? 'review_reply'.tr
                  : 'update_reply'.tr),
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      Row(children: [
                        ClipRRect(
                          ...
                          child: CustomImageWidget(
                            image:
                                '${Get.find<SplashController>().configModel!.baseUrls!.productImageUrl}/${widget.review.foodImage}',
                            height: 60,
                            width: 60,
                            fit: BoxFit.cover,
                          ),
                      ...
                      widget.restaurantReviewReplyStatus!
                          ? widget.isGiveReply
              ...
              ? Container(
                  ...
                  child: !restaurantController.isLoading
                      ? CustomButtonWidget(
                          onPressed: () {
                            if (widget.isGiveReply) {
                              restaurantController.updateReply(
