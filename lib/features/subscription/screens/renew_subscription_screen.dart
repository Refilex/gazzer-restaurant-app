...
import 'package:gazzer_vendorapp/features/subscription/widgets/refund_payment_card_widget.dart';
import 'package:gazzer_vendorapp/features/subscription/widgets/subscription_card_widget.dart';
import 'package:gazzer_vendorapp/features/subscription/widgets/subscription_payment_bottom_sheet_widget.dart';
import 'package:gazzer_vendorapp/helper/color_coverter_helper.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
        ...
        if (subscriptionController.packageModel != null) {
          for (var element in subscriptionController.packageModel!.packages!) {
            if (subscriptionController
                ...
                element.id) {
              activePackageIndex = subscriptionController
        ...
        return subscriptionController.packageModel != null
            ? Column(children: [
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
                          subscriptionController.renewStatus == 'packages'
                              ? SizedBox(
                                  height: 600,
                                  child: (subscriptionController.packageModel!
                                              .packages!.isNotEmpty &&
                                          subscriptionController.packageModel!
                                              .packages!.isNotEmpty)
                                      ? Swiper(
                                          itemCount: subscriptionController
                                              .packageModel!.packages!.length,
                                          ...
                                          itemBuilder: (BuildContext context,
                                            ...
                                            Color color = ColorConverterHelper
                                                .stringToColor(package.color);
                              ...
                              : Padding(
                                  ...
                                  child: Column(children: [
                                    RefundPaymentCardWidget(
                                      ...
                                      subTitle:
                                          '${PriceConverter.convertPrice(subscriptionController.profileModel!.balance)} ${'payable_amount_in_your_wallet'.tr}',
                                      index: 0,
                                      onTap: () {
                                        subscriptionController
                                            .setPaymentIndex(0);
                                              ...
                                              constraints: BoxConstraints(
                                                  maxHeight:
                                                      MediaQuery.of(context)
                                                          ...
                                                          0.8),
                                              child:
                                                  const SubscriptionPaymentBottomSheetWidget(),
                                            );
                                          },
                                        );
                                      },
                ...
                Padding(
                  ...
                  child: (subscriptionController
                      ...
                      ? !subscriptionController.isLoading
                          ? CustomButtonWidget(
                              buttonText:
                                  (subscriptionController.isActivePackage! &&
                                          activePackageIndex != -1)
                                      ? 'renew'.tr
                                      : 'shift_this_plan'.tr,
                              onPressed: () {
                                if (subscriptionController.renewStatus ==
                                    'packages') {
                                  subscriptionController
                                      .renewChangePackage('payment');
                                } else {
