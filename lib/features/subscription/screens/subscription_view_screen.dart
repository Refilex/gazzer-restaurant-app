...
import 'package:gazzer_vendorapp/features/subscription/widgets/billing_card_widget.dart';
import 'package:gazzer_vendorapp/features/subscription/widgets/plan_tile_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBarWidget(
          ...
          isBackButtonExist:
              Get.find<SubscriptionController>().profileModel!.id != null),
      body: Padding(
        ...
        child: GetBuilder<SubscriptionController>(
          ...
          return subscriptionController.profileModel != null
                          ...
                          Column(children: [
                            ...
                            Row(
                                ...
                                children: [
                                  ...
                                  (DateConverter.expireDifferanceInDays(
                                                  DateTime.parse(
                                      ...
                                      ? IconButton(
                                          onPressed: () =>
                                              subscriptionController.showAlert(
                                                  willUpdate: true),
                            ...
                            Container(
                              ...
                              child: Column(children: [
                                subscriptionController.profileModel!
                                            .subscription!.status ==
                                        1
                                    ? BillingCardWidget(
                                        logo: Images.billTime,
                                ...
                                BillingCardWidget(
                                  ...
                                  subTitle: (subscriptionController
                                      ...
                                      ? PriceConverter.convertPrice(
                                          subscriptionController.profileModel!
                                              .subscriptionOtherData!.totalBill)
                                      : '0',
                                ),
                                const SizedBox(
                                    height: Dimensions.paddingSizeExtraLarge),
                                BillingCardWidget(
                                    logo: Images.subscriptionLogo,
                                    title: 'number_of_uses'.tr,
                                    subTitle:
                                        '${subscriptionController.profileModel!.subscription!.totalPackageRenewed! + 1}'),
                              ]),
                            ),
                          ]),
                          (DateConverter.expireDifferanceInDays(DateTime.parse(
                                          subscriptionController.profileModel!
                                              .subscription!.expiryDate!)) <=
                                      10 &&
                                  subscriptionController
                                      .showSubscriptionAlertDialog &&
                                  subscriptionController.profileModel!.id !=
                                      null &&
                                  Get.find<SplashController>()
                                          .configModel!
                                          .businessPlan!
                        ...
                        Padding(
                          ...
                          child: Column(children: [
                            ...
                            PlanTileWidget(
                              title1: 'max_order'.tr,
                              title2:
                                  ' ${subscriptionController.profileModel!.subscription!.maxOrder == 'unlimited' ? '(${subscriptionController.profileModel!.subscription!.maxOrder.toString().tr})' : '(${subscriptionController.profileModel!.subscription!.maxOrder} ${'left'.tr})'}',
                            ),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            PlanTileWidget(
                              title1: 'max_product'.tr,
                              title2:
                                  ' ${subscriptionController.profileModel!.subscription!.maxOrder == 'unlimited' ? '(${subscriptionController.profileModel!.subscription!.maxProduct.toString().tr})' : '(${subscriptionController.profileModel!.subscriptionOtherData != null ? subscriptionController.profileModel!.subscriptionOtherData!.maxProductUpload : 0} ${'left'.tr})'}',
                            ),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            subscriptionController
                                    ...
                                    1
                                ? PlanTileWidget(
                                    title1: 'pos_access'.tr, title2: '')
                                : const SizedBox(),
                            SizedBox(
                                height: subscriptionController
                                            .profileModel!.subscription!.pos ==
                                        1
                                    ? Dimensions.paddingSizeSmall
                                    : 0),
                            subscriptionController.profileModel!.subscription!
                                        .mobileApp ==
                                    1
                                ? PlanTileWidget(
                                    title1: 'mobile_app_access'.tr, title2: '')
                                : const SizedBox(),
                            SizedBox(
                                height: subscriptionController.profileModel!
                            ...
                            subscriptionController
                                    ...
                                    1
                                ? PlanTileWidget(title1: 'chat'.tr, title2: '')
                                : const SizedBox(),
                            SizedBox(
                                height: subscriptionController
                                            .profileModel!.subscription!.chat ==
                                    ...
                                    : 0),
                            subscriptionController
                                        .profileModel!.subscription!.review ==
                                    1
                                ? PlanTileWidget(
                                    title1: 'review'.tr, title2: '')
                                : const SizedBox(),
                            SizedBox(
                                height: subscriptionController.profileModel!
                                            .subscription!.review ==
                            ...
                            subscriptionController.profileModel!.subscription!
                                    ...
                                    1
                                ? PlanTileWidget(
                                    title1: 'self_delivery'.tr, title2: '')
                                : const SizedBox(),
                            SizedBox(
                                height: subscriptionController.profileModel!
