...
class SubscriptionPaymentBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<SubscriptionPaymentBottomSheetWidget> createState() =>
      _SubscriptionPaymentBottomSheetWidgetState();
}

class _SubscriptionPaymentBottomSheetWidgetState
    extends State<SubscriptionPaymentBottomSheetWidget> {
  @override
            ...
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  bool isSelected = subscriptionController.paymentIndex == 1 &&
                  ...
                  onPressed: () {
                    if (widget.isWalletPayment) {
                      ...
                      Get.find<PaymentController>().makeCollectCashPayment(
                          amount,
                          Get.find<BusinessController>().digitalPaymentName!);
                    } else {
                      Get.back();
                    }
                  }),
