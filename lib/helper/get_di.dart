...
import 'package:gazzer_vendorapp/features/addon/controllers/addon_controller.dart';
import 'package:gazzer_vendorapp/features/addon/domain/repositories/addon_repository.dart';
import 'package:gazzer_vendorapp/features/addon/domain/repositories/addon_repository_interface.dart';
import 'package:gazzer_vendorapp/features/addon/domain/services/addon_service.dart';
...
import 'package:gazzer_vendorapp/features/auth/controllers/forgot_password_controller.dart';
import 'package:gazzer_vendorapp/features/auth/controllers/location_controller.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/auth_repository.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/forgot_password_repository.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/forgot_password_repository_interface.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/location_repository.dart';
import 'package:gazzer_vendorapp/features/auth/domain/repositories/location_repository_interface.dart';
import 'package:gazzer_vendorapp/features/auth/domain/services/auth_service.dart';
import 'package:gazzer_vendorapp/features/auth/domain/services/auth_service_interface.dart';
import 'package:gazzer_vendorapp/features/auth/domain/services/forgot_password_service.dart';
import 'package:gazzer_vendorapp/features/auth/domain/services/forgot_password_service_interface.dart';
import 'package:gazzer_vendorapp/features/auth/domain/services/location_service.dart';
...
import 'package:gazzer_vendorapp/features/business/domain/repositories/business_repository.dart';
import 'package:gazzer_vendorapp/features/business/domain/repositories/business_repository_interface.dart';
import 'package:gazzer_vendorapp/features/business/domain/services/business_service.dart';
import 'package:gazzer_vendorapp/features/business/domain/services/business_service_interface.dart';
import 'package:gazzer_vendorapp/features/campaign/controllers/campaign_controller.dart';
import 'package:gazzer_vendorapp/features/campaign/domain/repositories/campaign_repository.dart';
import 'package:gazzer_vendorapp/features/campaign/domain/repositories/campaign_repository_interface.dart';
import 'package:gazzer_vendorapp/features/campaign/domain/services/campaign_service.dart';
import 'package:gazzer_vendorapp/features/campaign/domain/services/campaign_service_interface.dart';
import 'package:gazzer_vendorapp/features/category/controllers/category_controller.dart';
import 'package:gazzer_vendorapp/features/category/domain/repositories/category_repository.dart';
import 'package:gazzer_vendorapp/features/category/domain/repositories/category_repository_interface.dart';
import 'package:gazzer_vendorapp/features/category/domain/services/category_service.dart';
import 'package:gazzer_vendorapp/features/category/domain/services/categoty_service_interface.dart';
import 'package:gazzer_vendorapp/features/chat/controllers/chat_controller.dart';
import 'package:gazzer_vendorapp/features/chat/domain/repositories/chat_repository.dart';
import 'package:gazzer_vendorapp/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:gazzer_vendorapp/features/chat/domain/services/chat_service.dart';
...
import 'package:gazzer_vendorapp/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:gazzer_vendorapp/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:gazzer_vendorapp/features/coupon/domain/services/coupon_service.dart';
import 'package:gazzer_vendorapp/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:gazzer_vendorapp/features/deliveryman/controllers/deliveryman_controller.dart';
import 'package:gazzer_vendorapp/features/deliveryman/domain/repositories/deliveryman_repository.dart';
import 'package:gazzer_vendorapp/features/deliveryman/domain/repositories/deliveryman_repository_interface.dart';
import 'package:gazzer_vendorapp/features/deliveryman/domain/services/deliveryman_service.dart';
...
import 'package:gazzer_vendorapp/features/disbursement/domain/repositories/disbursement_repository.dart';
import 'package:gazzer_vendorapp/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
import 'package:gazzer_vendorapp/features/disbursement/domain/services/disbursement_service.dart';
...
import 'package:gazzer_vendorapp/features/expense/domain/repositories/expense_repository.dart';
import 'package:gazzer_vendorapp/features/expense/domain/repositories/expense_repository_interface.dart';
import 'package:gazzer_vendorapp/features/expense/domain/services/expense_service.dart';
...
import 'package:gazzer_vendorapp/features/language/domain/repositories/language_repository.dart';
import 'package:gazzer_vendorapp/features/language/domain/repositories/language_repository_interface.dart';
import 'package:gazzer_vendorapp/features/language/domain/services/language_service.dart';
...
import 'package:gazzer_vendorapp/features/notification/domain/repositories/notification_repository.dart';
import 'package:gazzer_vendorapp/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:gazzer_vendorapp/features/notification/domain/services/notification_service.dart';
...
import 'package:gazzer_vendorapp/features/order/domain/repositories/order_repository.dart';
import 'package:gazzer_vendorapp/features/order/domain/repositories/order_repository_interface.dart';
import 'package:gazzer_vendorapp/features/order/domain/services/order_service.dart';
...
import 'package:gazzer_vendorapp/features/payment/domain/repositories/payment_repository.dart';
import 'package:gazzer_vendorapp/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:gazzer_vendorapp/features/payment/domain/services/payment_service.dart';
...
import 'package:gazzer_vendorapp/features/pos/domain/repositories/pos_repository.dart';
import 'package:gazzer_vendorapp/features/pos/domain/repositories/pos_repository_interface.dart';
import 'package:gazzer_vendorapp/features/pos/domain/services/pos_service.dart';
...
import 'package:gazzer_vendorapp/features/profile/domain/repositories/profile_repository.dart';
import 'package:gazzer_vendorapp/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:gazzer_vendorapp/features/profile/domain/services/profile_service.dart';
...
import 'package:gazzer_vendorapp/features/reports/domain/repositories/report_repository.dart';
import 'package:gazzer_vendorapp/features/reports/domain/repositories/report_repository_interface.dart';
import 'package:gazzer_vendorapp/features/reports/domain/services/report_service.dart';
...
import 'package:gazzer_vendorapp/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/services/restaurant_service.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/services/restaurant_service_interface.dart';
import 'package:gazzer_vendorapp/features/splash/controllers/splash_controller.dart';
import 'package:gazzer_vendorapp/features/splash/domain/repositories/splash_repository.dart';
import 'package:gazzer_vendorapp/features/splash/domain/repositories/splash_repository_service.dart';
import 'package:gazzer_vendorapp/features/splash/domain/services/splash_service.dart';
import 'package:gazzer_vendorapp/features/splash/domain/services/splash_service_interface.dart';
import 'package:gazzer_vendorapp/features/subscription/controllers/subscription_controller.dart';
import 'package:gazzer_vendorapp/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:gazzer_vendorapp/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:gazzer_vendorapp/features/subscription/domain/services/subscription_service.dart';
import 'package:gazzer_vendorapp/features/subscription/domain/services/subscription_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  AddonRepositoryInterface addonRepoInterface =
      AddonRepository(apiClient: Get.find());
  Get.lazyPut(() => addonRepoInterface);

  BusinessRepositoryInterface businessPlanRepoInterface =
  ...
  ReportRepositoryInterface reportRepositoryInterface =
      ReportRepository(apiClient: Get.find());
  ...
  AddonServiceInterface addonServiceInterface =
      AddonService(addonRepoInterface: Get.find());
  Get.lazyPut(() => addonServiceInterface);

  BusinessServiceInterface businessServiceInterface =
      BusinessService(businessRepositoryInterface: Get.find());
  ...
  ReportServiceInterface reportServiceInterface =
      ReportService(reportRepositoryInterface: Get.find());
