import 'dart:convert';
import 'package:gazzer_vendorapp/common/screens/payment_screen.dart';
import 'package:gazzer_vendorapp/features/business/screens/payment_successful_screen.dart';
import 'package:gazzer_vendorapp/features/campaign/screens/campaign_details_screen.dart';
import 'package:gazzer_vendorapp/features/campaign/screens/campaign_screen.dart';
import 'package:gazzer_vendorapp/features/category/screens/category_screen.dart';
...
import 'package:gazzer_vendorapp/features/category/domain/models/category_model.dart';
import 'package:gazzer_vendorapp/features/chat/domain/models/conversation_model.dart';
import 'package:gazzer_vendorapp/features/dashboard/screens/dashboard_screen.dart';
import 'package:gazzer_vendorapp/features/deliveryman/domain/models/delivery_man_model.dart';
import 'package:gazzer_vendorapp/features/deliveryman/screens/add_delivery_man_screen.dart';
import 'package:gazzer_vendorapp/features/deliveryman/screens/delivery_man_details_screen.dart';
import 'package:gazzer_vendorapp/features/deliveryman/screens/delivery_man_screen.dart';
import 'package:gazzer_vendorapp/features/disbursement/screens/add_withdraw_method_screen.dart';
import 'package:gazzer_vendorapp/features/disbursement/screens/disbursement_menu_screen.dart';
import 'package:gazzer_vendorapp/features/disbursement/screens/disbursement_screen.dart';
import 'package:gazzer_vendorapp/features/disbursement/screens/withdraw_method_screen.dart';
import 'package:gazzer_vendorapp/features/expense/screens/expense_screen.dart';
import 'package:gazzer_vendorapp/features/auth/screens/forget_pass_screen.dart';
import 'package:gazzer_vendorapp/features/auth/screens/new_pass_screen.dart';
import 'package:gazzer_vendorapp/features/auth/screens/verification_screen.dart';
import 'package:gazzer_vendorapp/features/html/screens/html_viewer_screen.dart';
import 'package:gazzer_vendorapp/features/language/screens/language_screen.dart';
import 'package:gazzer_vendorapp/features/notification/screens/notification_screen.dart';
import 'package:gazzer_vendorapp/features/order/domain/models/order_model.dart';
import 'package:gazzer_vendorapp/features/payment/screens/bank_info_screen.dart';
import 'package:gazzer_vendorapp/features/payment/screens/payment_history_screen.dart';
import 'package:gazzer_vendorapp/features/payment/screens/wallet_screen.dart';
import 'package:gazzer_vendorapp/features/payment/screens/withdraw_request_history_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/models/product_model.dart';
import 'package:gazzer_vendorapp/features/order/screens/order_details_screen.dart';
import 'package:gazzer_vendorapp/features/pos/screens/pos_screen.dart';
import 'package:gazzer_vendorapp/features/profile/domain/models/profile_model.dart';
import 'package:gazzer_vendorapp/features/addon/screens/addon_screen.dart';
import 'package:gazzer_vendorapp/features/auth/screens/restaurant_registration_screen.dart';
import 'package:gazzer_vendorapp/features/auth/screens/sign_in_screen.dart';
import 'package:gazzer_vendorapp/features/chat/screens/chat_screen.dart';
import 'package:gazzer_vendorapp/features/chat/screens/conversation_screen.dart';
import 'package:gazzer_vendorapp/features/coupon/screens/coupon_screen.dart';
import 'package:gazzer_vendorapp/features/profile/screens/profile_screen.dart';
import 'package:gazzer_vendorapp/features/profile/screens/update_profile_screen.dart';
import 'package:gazzer_vendorapp/features/reports/screens/campaign/screens/campaign_report_screen.dart';
import 'package:gazzer_vendorapp/features/reports/screens/food/screens/food_report_screen.dart';
import 'package:gazzer_vendorapp/features/reports/screens/order/screens/order_report_screen.dart';
import 'package:gazzer_vendorapp/features/reports/screens/reports_screen.dart';
import 'package:gazzer_vendorapp/features/reports/screens/transaction/screens/transaction_report_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/domain/models/review_model.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/add_name_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/add_product_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/announcement_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/product_details_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/restaurant_screen.dart';
import 'package:gazzer_vendorapp/features/restaurant/screens/restaurant_settings_screen.dart';
import 'package:gazzer_vendorapp/features/review/screens/customer_review_screen.dart';
import 'package:gazzer_vendorapp/features/review/screens/review_reply_screen.dart';
import 'package:gazzer_vendorapp/features/splash/screens/splash_screen.dart';
import 'package:gazzer_vendorapp/features/subscription/screens/renew_subscription_screen.dart';
import 'package:gazzer_vendorapp/features/subscription/screens/subscription_view_screen.dart';
import 'package:gazzer_vendorapp/features/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static String getUpdateRoute(bool willUpdate) =>
      '$update?update=${willUpdate.toString()}';
  ...
  static String getAddProductRoute(
  ...
  static String getSuccessRoute(String status,
          {bool isWalletPayment = false}) =>
      '$success?status=$status&is_wallet_payment=${isWalletPayment.toString()}';

  static String getAnnouncementRoute(
      {required int announcementStatus, required announcementMessage}) {
  ...
  static String getWithdrawMethodRoute({bool isFromDashBoard = false}) =>
      '$withdrawMethod?from_dashboard=$isFromDashBoard';
  ...
  static String getReviewReplyRoute(
      {bool isGiveReply = false,
      required ReviewModel review,
      bool restaurantReviewReplyStatus = false}) {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () => const WithdrawRequestHistoryScreen()),
        ...
        translations.add(Translation.fromJson(data));
          ...
          if (Get.parameters['data'] == 'null') {
            return const AddProductScreen(
              product: null, /*translations: translations*/
            );
          }
          List<int> decode =
              base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
          ...
          return AddProductScreen(
            product: data, /*translations: translations*/
          );
        }),
    GetPage(
        name: categories,
    ...
    GetPage(
        ...
        page: () {
          List<int> decode =
              base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
          Restaurant data =
              Restaurant.fromJson(jsonDecode(utf8.decode(decode)));
    ...
    GetPage(
        name: update,
        page: () =>
            UpdateScreen(willUpdate: Get.parameters['update'] == 'true')),
    GetPage(
        name: chatScreen,
        page: () {
    ...
    GetPage(
        name: renewSubscription, page: () => const RenewSubscriptionScreen()),
    ...
    GetPage(
        ...
        page: () {
          ...
          return PaymentScreen(
              paymentMethod: paymentMethod, redirectUrl: addFundUrl);
        }),
    GetPage(
        name: success,
        page: () => PaymentSuccessfulScreen(
            success: Get.parameters['status'] == 'success',
            isWalletPayment: Get.parameters['is_wallet_payment'] == 'true')),
    GetPage(
        name: announcement,
        page: () => AnnouncementScreen(
              announcementStatus:
                  int.parse(Get.parameters['announcement_status']!),
              announcementMessage: Get.parameters['announcement_message']!,
            )),
    GetPage(
        name: transactionReport, page: () => const TransactionReportScreen()),
    ...
    GetPage(
        ...
        page: () => WithdrawMethodScreen(
            isFromDashboard: Get.parameters['from_dashboard'] == 'true')),
    GetPage(
    ...
    GetPage(
        ...
        page: () {
          List<int> decode =
              base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
          ReviewModel data =
              ReviewModel.fromJson(jsonDecode(utf8.decode(decode)));
          return ReviewReplyScreen(
              isGiveReply: Get.parameters['is_give_reply'] == 'true',
              review: data,
              restaurantReviewReplyStatus:
                  Get.parameters['restaurant_review_reply_status'] == 'true');
        })
  ];
}
